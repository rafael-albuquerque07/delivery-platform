...
**tem que bater** com a soma das liquidações registradas (H7.3). Isso é teste,
não esperança.
...
| J9 | `Σ fechamentos.LD` do dia == `Σ liquidações DINHEIRO` do dia | O total do dia não bate (H7.3) |
