package com.deliveryplatform.conversation.architecture;
 ...
 *
 * allowEmptyShould(true) é MULETA TEMPORÁRIA: enquanto as camadas só têm
 * .gitkeep, zero classes casando conta como falha no ArchUnit. REMOVA assim que
 * este serviço tiver classes de verdade — mantida depois, uma camada apagada ou
 * um pacote renomeado passa em silêncio, que é o oposto do que este teste faz.
 */
@AnalyzeClasses(packages = "com.deliveryplatform.conversation")
